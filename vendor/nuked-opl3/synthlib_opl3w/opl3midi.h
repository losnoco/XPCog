...
class OPL3MIDI : public midisynth {
	private:
	// XPCog local change: initialised for the reason i_oplmusic.h gives at
	// length -- ~OPL3MIDI deletes this whether or not midi_init() ever ran.
	fm_chip *opl_chip = nullptr;
	bool opl_opl3mode;
	bool opl_extp;
