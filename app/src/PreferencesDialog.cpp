...
wxWindow* PreferencesDialog::buildPlaylistPane(wxWindow* parent) {
    ...
    row->toggle(_("Keep playing while looking for the next playable track"),
                ...
                _("When Next or Previous lands on a track that will not open, "
                  "carry on playing the current one until a playable track is "
                  "found."));
...
wxWindow* PreferencesDialog::buildPitchTempoPane(wxWindow* parent) {
    ...
    auto* pitchSlider = new wxSlider(pane, wxID_ANY, sliderFromSpeed(settings_.Pitch()),
                                     0, kSpeedSliderMax, wxDefaultPosition,
