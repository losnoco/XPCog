...
:: -> build\windows-release\XPCog-1.5.0-x64-setup.exe
```
...
```bat
XPCog-1.5.0-x64-setup.exe /S /CurrentUser /NOASSOC /D=C:\Somewhere\XPCog
```
...
tar tzf build/linux-repo-release/XPCog-1.5.0-x86_64.tar.gz
```
